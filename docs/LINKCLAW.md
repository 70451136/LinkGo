...
如果你想快速了解 LinkClaw 的真实使用界面、运行时面板、PPT 文件问答和保留格式翻译流程，请查看 [LinkClaw 工作流图册](LINKCLAW_WORKFLOW_GALLERY.md)。
...
To see LinkClaw's real interface, runtime dashboard, PowerPoint file Q&A, and format-preserving translation workflow, open the [LinkClaw Workflow Gallery](LINKCLAW_WORKFLOW_GALLERY.md).
